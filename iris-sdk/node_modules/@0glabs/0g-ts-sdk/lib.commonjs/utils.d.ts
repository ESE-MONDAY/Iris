...
export declare function getFlowContract(address: string, signer: Signer): import("../src.ts/contracts/flow/FixedPriceFlow.js").FixedPriceFlow;
export declare function getMarketContract(address: string, runner: ContractRunner): import("../src.ts/contracts/market/FixedPrice.js").FixedPrice;
